This is a fork of [poga/godot-dash-docset](https://github.com/poga/godot-dash-docset) using the documentation for Godot 4.2, and a few other tweaks to make it easier to update.
---
